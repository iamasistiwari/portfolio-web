  ...
  return (
    <div className=' p-5 rounded-xl transition-all duration-200'>
        ...
        {Frontend_skill.map((stack, index) => {
            ...
            return (
                <div key={index} className='flex border-neutral-900 rounded-2xl border bg-neutral-950 mb-4 opacity-85 max-w-[620px]  items-center hover:bg-neutral-800 transition-all duration-200'>
