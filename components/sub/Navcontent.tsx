...
export default function Navcontent() {
  return (
    <div className='w-full fixed top-0 z-50 bg-black flex justify-center px-2 lg:border-b border-neutral-900  py-4 space-x-3 lg:space-x-6 transition-all duration-200 lg:text-xl'>
        ...
        <a href='#home' className='flex border px-2 py-2 border-neutral-800 rounded-xl hover:bg-neutral-900 hover:cursor-pointer opacity-70 hover:opacity-100'>  
        ...
        <a href='#skills' className='flex border px-2 py-2 border-neutral-800 rounded-xl hover:bg-neutral-900 hover:cursor-pointer opacity-70 hover:opacity-100'>  
            <div className='relative w-4 h-4 lg:w-6 lg:h-6 overflow-hidden mt-[2.5px] lg:mt-0'>
                <Image
                className='rounded-3xl object-cover'
        ...
        <a href='#projects8' className='flex border px-2 py-2 border-neutral-800 rounded-xl hover:bg-neutral-900 hover:cursor-pointer opacity-70 hover:opacity-100'>  
            <div className='relative w-4 h-4 lg:w-6 lg:h-6 overflow-hidden mt-[2.5px] lg:mt-0'>
            <Image
            className='rounded-3xl object-cover'
